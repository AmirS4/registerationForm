    ...
    if (!preg_match("/^[a-zA-z]*$/", $name)) {
        ...
        ");
            ...
            $mail->Body = "
                 ...
                 <a href='https://pezhmanbirack.ir/AmirS4/registeration-form/confirm.php?email=$email&token=$token'>Click Here</a>
            ";
            if ($mail->send())
...
<div class="container" style="margin-top: 100px;">
    <div class="row justify-content-center">
        <div class="col-md-6 col-md-offset-3" align="center">
            ...
            <a href="https://pezhmanbirack.ir/AmirS4/registeration-form/login.php">All ready a user? Login here!</a><br><br>
            ...
            <form id="form" method="post" action="register.php">
                ...
                <div class="form-group col-md-12">
                    <input class="btn btn-primary" name="submit" id="submit" type="submit" value="Register"
                           disabled="disabled">
                </div>
            </form>
            <style>
            ...
            <script>
                $(document).ready(function () {
                    ...
                    $("#form").submit(function (event) {
                        ...
                        $.ajax({
                            type: "post",
                            url: "https://pezhmanbirack.ir/AmirS4/registeration-form/register.php",
                            data: formData,
                            cache: false,
                            // processData: false,
                            // dataType: "json",
